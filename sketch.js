...
gameOver.scale = 0.5; restart.scale = 0.1;
...
//change the kangaroo animation kangaroo.changeAnimation("collided", kangaroo_collided);
kangaroo.changeAnimation("collided", kangaroo_collided)
//set lifetime of the game objects so that they are never destroyed obstaclesGroup.setLifetimeEach(-1); shrubsGroup.setLifetimeEach(-1);
obstaclesGroup.setLifetimeEach(-1);
shrubsGroup.setLifetimeEach(-1);
